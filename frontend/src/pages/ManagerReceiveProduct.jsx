      ...
      <div className="flex-1 flex flex-col min-w-0 w-full">
        ...
        <div className="navbar bg-[#e9d5ff] border-b border-[#ddd6fe] px-4 sm:px-6 shadow-xs flex justify-between items-center relative z-10">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-semibold text-[#2e1065]">Receive Product</span>
          </div>
        ...
        <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center px-4">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm p-6">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h2 className="text-lg font-bold text-[#2e1065]">Product received successfully!</h2>
            </div>

            <div className="space-y-1.5 text-sm text-[#2e1065]/90 mb-5">
              <p><span className="font-semibold">Product:</span> {confirmation.product}</p>
              <p><span className="font-semibold">Quantity Received:</span> {confirmation.quantity}</p>
              <p><span className="font-semibold">Supplier:</span> {confirmation.supplier}</p>
              <p><span className="font-semibold">Updated Stock:</span> {confirmation.updatedStock}</p>
            </div>
